...
export default function AlbumContent({data}) {
    ...
    return (
        <div
            ...
            <h1 className="text-4xl mb-5 font-black md:text-4xl text-center max-w-[620px] mx-auto">
                {data.title}
                <h3 className="text-gray-500 text-center text-sm font-light">{data.count} Photos</h3>

            </h1>

            <div className="inline-block mx-auto data-content mt-2 w-full">
