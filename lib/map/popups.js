...
<div class="text-black">
    ...
    <p class='text-gray-500'> Velocity: <span class="font-bold">${waypoint.velocity || ''}</span></p>
    <p class='text-gray-500'> Course: <span class="font-bold">${waypoint.course || ''}</span></p>
</div>`
    )
}
