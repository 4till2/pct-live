import {
    ...
    Sun,
    Rss,
    Moon, MessageCircle, Wind, Aperture
} from "react-feather";
import {Info, LightBulb} from "@githubprimer/octicons-react";

const iconWidth = 1

export const HomeIcon = (
    <Home className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const BlogIcon = (
    <PenTool className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const SunIcon = (
    <Sun className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const MoonIcon = (
    <Moon className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const MapIcon = (
    <Map className="w-5 h-5" strokeWidth={iconWidth}/>
);
export const TimelineIcon = (
    <Circle className="w-5 h-5" strokeWidth={iconWidth}/>
);
export const BlipIcon = (
    <Wind className="w-5 h-5" strokeWidth={iconWidth}/>
);
export const InfoIcon = (
    <Info className="w-2 h-2" strokeWidth={iconWidth}/>
);
export const AlbumIcon = (
    <Aperture className="w-2 h-2" strokeWidth={iconWidth}/>
);
export const LogIcon = (
    <Activity className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const InstagramIcon = (
    <Instagram className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const TwitterIcon = (
    <Twitter className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const ExternalLinkIcon = (
    <ExternalLink className="w-5 h-5" strokeWidth={iconWidth}/>
);
export const RssIcon = (
    <Rss className="w-5 h-5" strokeWidth={iconWidth}/>
);

export const EmailIcon = (
    <Send className="w-5 h-5" strokeWidth={iconWidth}/>
);
